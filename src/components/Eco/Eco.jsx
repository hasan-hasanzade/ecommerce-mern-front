         ...
         <div className={styles.wrapper}>
            ...
            <div className={styles.body}>
               <div className={styles.inner}>
                  ...
                  <h2 className={styles.title}>Econis is a Friendly <br /> Organic Store</h2>
                  <div className={styles.content}>
                     <div className={styles.item}>
                        <h5 className={styles.heading}>Start with Our Company First</h5>
                        <p className={styles.text}>Sed ut perspiciatis unde omnis iste natus error sit voluptat accusantium doloremque laudantium. Sed ut perspiciatis.</p>
                     </div>
                     <div className={styles.item}>
